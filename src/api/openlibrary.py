...
class OpenLibraryClient:
    ...
    def __init__(self, config: Config):
        ...
        self.headers = {"User-Agent": f"{config.server.name}/{config.server.version} (Educational MCP Server)"}
    ...
    async def _make_request(self, endpoint: str, params: Optional[Dict[str, Any]] = None, retry_count: int = 0) -> Dict[str, Any]:
        """
    ...
    async def search_books(self, query: str, limit: int = 10, fields: Optional[List[str]] = None) -> List[Dict[str, Any]]:
        """
        ...
        if fields is None:
            fields = ["key", "title", "author_name", "first_publish_year", "isbn", "publisher", "subject", "cover_i", "number_of_pages_median", "language", "description"]

        params = {"q": query, "limit": limit, "fields": ",".join(fields)}
    ...
    async def get_book_cover(self, isbn: str, size: str = "M") -> Optional[str]:
        """
    ...
    async def check_book_availability(self, isbn: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if not book_details:
                return {"available": False, "status": "not_found", "message": "Book not found in Open Library"}
    ...
    async def search_by_subject(self, subject: str, limit: int = 10) -> List[Dict[str, Any]]:
        """
    ...
    async def get_trending_books(self, subject: Optional[str] = None, limit: int = 10) -> List[Dict[str, Any]]:
        """
