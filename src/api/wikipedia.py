...
class WikipediaClient:
    ...
    def __init__(self, config: Config):
        ...
        self.headers = {"User-Agent": f"{config.server.name}/{config.server.version} (Educational MCP Server; https://github.com/openedu-mcp)"}
    ...
    async def _make_request(self, url: str, params: Optional[Dict[str, Any]] = None, retry_count: int = 0, use_action_api: bool = False, lang: str = "en") -> Dict[str, Any]:
        """
    ...
    async def search_wikipedia(self, query: str, lang: str = "en", limit: int = 5) -> List[Dict[str, Any]]:
        """
        ...
        params = {"action": "query", "format": "json", "list": "search", "srsearch": query, "srlimit": limit, "srprop": "snippet|titlesnippet|size|wordcount|timestamp", "utf8": 1}
    ...
    async def search_titles(self, query: str, lang: str = "en", limit: int = 3) -> List[str]:
    ...
    async def get_article_summary(self, title: str, lang: str = "en") -> Dict[str, Any]:
        """
    ...
    async def _extract_tables(self, title: str, lang: str = "en", max_tables: int = 5, max_chars_per_table: int = 3000) -> List[Dict[str, str]]:
    ...
    async def get_daily_featured(self, date_param: Optional[Union[str, date]] = None, lang: str = "en") -> Dict[str, Any]:
        """
    ...
    async def get_article_images(self, title: str, lang: str = "en") -> List[Dict[str, Any]]:
        """
        Get article images.
        ...
        try:
            ...
            params = {"action": "query", "format": "json", "titles": title, "prop": "images", "imlimit": 10, "utf8": 1}
            ...
            for img in page_data["images"]:
                ...
                # Get image info
                try:
                    img_params = {"action": "query", "format": "json", "titles": img_title, "prop": "imageinfo", "iiprop": "url|size|mime", "utf8": 1}
                    ...
                    if "query" in img_response and "pages" in img_response["query"]:
                        ...
                        if "imageinfo" in img_data and img_data["imageinfo"]:
                            ...
                            images.append(
                                {"title": img_title, "url": img_info.get("url", ""), "width": img_info.get("width", 0), "height": img_info.get("height", 0), "mime": img_info.get("mime", "")}
                            )
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"status": "healthy", "response_time_seconds": response_time, "timestamp": end_time.isoformat(), "api_url": self.base_url}

        except Exception as e:
            return {"status": "unhealthy", "error": str(e), "timestamp": datetime.now().isoformat(), "api_url": self.base_url}
