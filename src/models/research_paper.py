...
class ResearchPaper(BaseModel):
    ...
    def from_arxiv(cls, arxiv_data: Dict[str, Any]) -> "ResearchPaper":
        ...
        educational_keywords = ["education", "teaching", "learning", "pedagogy", "curriculum", "student", "classroom", "instruction", "assessment", "educational"]
    ...
    def has_educational_focus(self) -> bool:
        ...
        educational_terms = ["education", "teaching", "learning", "pedagogy", "curriculum", "instruction", "classroom", "student", "educational"]
    ...
    def get_complexity_level(self) -> str:
        ...
        technical_terms = ["algorithm", "theorem", "proof", "analysis", "methodology", "framework", "model", "optimization", "statistical"]
    ...
    def is_suitable_for_educators(self) -> bool:
        ...
        return (
            self.has_educational_focus()
            or self.educational_metadata.educational_relevance_score > 0.5
            or "High School Teachers" in self.target_audience
            or "Undergraduate Students" in self.target_audience
        )
