...
async def initialize_services() -> None:
    ...
    try:
        ...
        openlibrary_tool = OpenLibraryTool(config=config, cache_service=cache_service, rate_limiting_service=rate_limiting_service, usage_service=usage_service)
        logger.info("Open Library tool initialized")

        # Initialize Wikipedia tool
        wikipedia_tool = WikipediaTool(config=config, cache_service=cache_service, rate_limiting_service=rate_limiting_service, usage_service=usage_service)
        logger.info("Wikipedia tool initialized")

        # Initialize Dictionary tool
        dictionary_tool = DictionaryTool(config=config, cache_service=cache_service, rate_limiting_service=rate_limiting_service, usage_service=usage_service)
        logger.info("Dictionary tool initialized")

        # Initialize arXiv tool
        arxiv_tool = ArxivTool(config=config, cache_service=cache_service, rate_limiting_service=rate_limiting_service, usage_service=usage_service)
...
@mcp.tool()
async def search_educational_books(ctx: Context, query: str, subject: Optional[str] = None, grade_level: Optional[str] = None, limit: int = 10) -> List[Dict[str, Any]]:
    """
    ...
    try:
        return await openlibrary_tool.search_educational_books(query=query, subject=subject, grade_level=grade_level, limit=limit, user_session=getattr(ctx, "session_id", None))
    except Exception as e:
...
@mcp.tool()
async def get_book_details_by_isbn(ctx: Context, isbn: str, include_cover: bool = True) -> Dict[str, Any]:
    """
    ...
    try:
        return await openlibrary_tool.get_book_details_by_isbn(isbn=isbn, include_cover=include_cover, user_session=getattr(ctx, "session_id", None))
    except Exception as e:
...
@mcp.tool()
async def search_books_by_subject(ctx: Context, subject: str, grade_level: Optional[str] = None, limit: int = 10) -> List[Dict[str, Any]]:
    """
    ...
    try:
        return await openlibrary_tool.search_books_by_subject(subject=subject, grade_level=grade_level, limit=limit, user_session=getattr(ctx, "session_id", None))
    except Exception as e:
...
@mcp.tool()
async def get_book_recommendations(ctx: Context, grade_level: str, subject: Optional[str] = None, limit: int = 10) -> List[Dict[str, Any]]:
    """
    ...
    try:
        return await openlibrary_tool.get_book_recommendations(grade_level=grade_level, subject=subject, limit=limit, user_session=getattr(ctx, "session_id", None))
    except Exception as e:
...
@mcp.tool()
async def search_educational_articles(ctx: Context, query: str, subject: Optional[str] = None, grade_level: Optional[str] = None, language: str = "en", limit: int = 10) -> List[Dict[str, Any]]:
    """
    ...
    try:
        return await wikipedia_tool.search_educational_articles(query=query, subject=subject, grade_level=grade_level, language=language, limit=limit, user_session=getattr(ctx, "session_id", None))
    except Exception as e:
...
@mcp.tool()
async def get_article_summary(ctx: Context, title: str, language: str = "en", include_educational_analysis: bool = True) -> Dict[str, Any]:
    """
    ...
    try:
        return await wikipedia_tool.get_article_summary(title=title, language=language, include_educational_analysis=include_educational_analysis, user_session=getattr(ctx, "session_id", None))
    except Exception as e:
...
@mcp.tool()
async def get_article_content(ctx: Context, title: str, language: str = "en", include_images: bool = False) -> Dict[str, Any]:
    """
    ...
    try:
        return await wikipedia_tool.get_article_content(title=title, language=language, include_images=include_images, user_session=getattr(ctx, "session_id", None))
    except Exception as e:
...
@mcp.tool()
async def get_featured_article(ctx: Context, date: Optional[str] = None, language: str = "en") -> Dict[str, Any]:
    """
    ...
    try:
        return await wikipedia_tool.get_featured_article(date_param=date, language=language, user_session=getattr(ctx, "session_id", None))
    except Exception as e:
...
@mcp.tool()
async def get_articles_by_subject(ctx: Context, subject: str, grade_level: Optional[str] = None, language: str = "en", limit: int = 10) -> List[Dict[str, Any]]:
    """
    ...
    try:
        return await wikipedia_tool.get_articles_by_subject(subject=subject, grade_level=grade_level, language=language, limit=limit, user_session=getattr(ctx, "session_id", None))
    except Exception as e:
...
@mcp.tool()
async def get_word_definition(ctx: Context, word: str, grade_level: Optional[str] = None, include_pronunciation: bool = True) -> Dict[str, Any]:
    """
    ...
    try:
        return await dictionary_tool.get_word_definition(word=word, grade_level=grade_level, include_pronunciation=include_pronunciation, user_session=getattr(ctx, "session_id", None))
    except Exception as e:
...
@mcp.tool()
async def get_vocabulary_analysis(ctx: Context, word: str, context: Optional[str] = None) -> Dict[str, Any]:
    """
    ...
    try:
        return await dictionary_tool.get_vocabulary_analysis(word=word, context=context, user_session=getattr(ctx, "session_id", None))
    except Exception as e:
...
@mcp.tool()
async def get_word_examples(ctx: Context, word: str, grade_level: Optional[str] = None, subject: Optional[str] = None) -> Dict[str, Any]:
    """
    ...
    try:
        return await dictionary_tool.get_word_examples(word=word, grade_level=grade_level, subject=subject, user_session=getattr(ctx, "session_id", None))
    except Exception as e:
...
@mcp.tool()
async def get_pronunciation_guide(ctx: Context, word: str, include_audio: bool = True) -> Dict[str, Any]:
    """
    ...
    try:
        return await dictionary_tool.get_pronunciation_guide(word=word, include_audio=include_audio, user_session=getattr(ctx, "session_id", None))
    except Exception as e:
...
@mcp.tool()
async def get_related_vocabulary(ctx: Context, word: str, relationship_type: str = "all", grade_level: Optional[str] = None, limit: int = 10) -> Dict[str, Any]:
    """
    ...
    try:
        return await dictionary_tool.get_related_vocabulary(word=word, relationship_type=relationship_type, grade_level=grade_level, limit=limit, user_session=getattr(ctx, "session_id", None))
    except Exception as e:
...
async def search_academic_papers(
    ctx: Context, query: str, subject: Optional[str] = None, academic_level: Optional[str] = None, max_results: int = 10, include_educational_analysis: bool = True
) -> List[Dict[str, Any]]:
    """
...
@mcp.tool()
async def get_paper_summary(ctx: Context, paper_id: str, include_educational_analysis: bool = True) -> Dict[str, Any]:
    """
    ...
    try:
        return await arxiv_tool.get_paper_summary(paper_id=paper_id, include_educational_analysis=include_educational_analysis, user_session=getattr(ctx, "session_id", None))
    except Exception as e:
...
@mcp.tool()
async def get_recent_research(ctx: Context, subject: str, days: int = 7, academic_level: Optional[str] = None, max_results: int = 10) -> List[Dict[str, Any]]:
    """
    ...
    try:
        return await arxiv_tool.get_recent_research(subject=subject, days=days, academic_level=academic_level, max_results=max_results, user_session=getattr(ctx, "session_id", None))
    except Exception as e:
...
@mcp.tool()
async def get_research_by_level(ctx: Context, academic_level: str, subject: Optional[str] = None, max_results: int = 10) -> List[Dict[str, Any]]:
    """
    ...
    try:
        return await arxiv_tool.get_research_by_level(academic_level=academic_level, subject=subject, max_results=max_results, user_session=getattr(ctx, "session_id", None))
    except Exception as e:
...
@mcp.tool()
async def analyze_research_trends(ctx: Context, subject: str, days: int = 30) -> Dict[str, Any]:
    """
    ...
    try:
        return await arxiv_tool.analyze_research_trends(subject=subject, days=days, user_session=getattr(ctx, "session_id", None))
    except Exception as e:
...
async def get_server_status(ctx: Context) -> Dict[str, Any]:
    ...
    if not cache_service or not rate_limiting_service or not usage_service:
        return {"status": "error", "message": "Server services not properly initialized"}
    ...
    try:
        ...
        return {
            "status": "healthy",
            "server": {"name": config.server.name if config else "openedu-mcp-server", "version": config.server.version if config else "1.0.0"},
            "cache": cache_stats,
